...
public class SaveForLaterTest extends Base {
   ...
   public WebDriver driver;
    private static final Logger logger = LogManager.getLogger(SaveForLaterTest.class);

    
    @Test
    public void SaveCart() throws IOException, InterruptedException {
        ...
        for (Map<String, String> testCase : testCases) {
            ...
            if (executionRequired.equalsIgnoreCase("Yes")) {
                ...
                // Click the save later button
                WebElement saveLaterButton = cart.SaveForLater();
                ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", saveLaterButton);
                ...
                logger.info("Item saved for later is displayed.");
